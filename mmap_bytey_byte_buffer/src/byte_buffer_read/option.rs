...
impl<T: MByteBufferRead> MByteBufferRead for Option<T> {
    #[inline]
    fn read_from_buffer(buffer: &mut MByteBuffer) -> Result<Option<T>> {
    ...
    #[inline]
    fn read_from_buffer_le(buffer: &mut MByteBuffer) -> Result<Option<T>> {
    ...
    #[inline]
    fn read_from_buffer_be(buffer: &mut MByteBuffer) -> Result<Option<T>> {
